...
import {isValidTextRotationAlignment} from '../symbol/text_rotation_alignment.ts';
...
FormatExpressionClass.parse = function(args: readonly unknown[], context: any) {
    if (args.length < 2) {
    ...
    const sections: ExtendedFormattedSectionExpression[] = [];
