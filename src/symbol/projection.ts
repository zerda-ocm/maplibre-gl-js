...
import {planetScaleAtLatitude} from '../geo/projection/globe_utils.ts';
import {shouldRotateGlyphToLine, TextRotationAlignmentOverrideValue} from '../symbol/text_rotation_alignment.ts';
